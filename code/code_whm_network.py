...
class LUConv_bottle(nn.Module):
    def __init__(self, nchan, elu, act):
        ...
        self.conv1 = nn.Conv2d(nchan, nchan//4, kernel_size=1, padding=0)
        self.bn1 = nn.BatchNorm2d(nchan//4)
        
        self.relu2 = ELUCons(elu, nchan//4)
        self.conv2 = nn.Conv2d(nchan//4, nchan//4, kernel_size=3, padding=1)
        self.bn2 = nn.BatchNorm2d(nchan//4)
        
        self.relu3 = ELUCons(elu, nchan)
        self.conv3 = nn.Conv2d(nchan//4, nchan, kernel_size=1, padding=0)
        self.bn3 = nn.BatchNorm2d(nchan)
...
class SegmentationNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, elu=True):
