...
from code_whm_utils import save_pytorch_model, load_pytorch_model, EpochConcateSampler
from code_whm_dataset import SegmentationDataset
from code_whm_network import SegmentationNet, vnet_kaiming_init, vnet_focal_init
from code_whm_loss import MultiDiceLoss, FocalLoss
...
def train(config_file, msg_queue=None):
    ...
    net = SegmentationNet(dataset.num_modality(), cfg.dataset.num_classes)
    max_stride = [16, 16]
...
def main():
    ...
    parser.add_argument('-i', '--input', nargs='?', default="/data/qingzhou/whm/code_config.py",
